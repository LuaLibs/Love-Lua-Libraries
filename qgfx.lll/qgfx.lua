...
mkl.version("Love Lua Libraries (LLL) - qgfx.lua","17.08.17")
...
love.graphics.draw(i.image,x,y,rad or 0,i.scalex or sx or 1, i.scaley or i.scalex or sy or sx or 1,i.ox or 0, i.oy or 0)
--love.graphics.pop()                   
end 
